...
- [x] 1. 固定 API 合约；实现模型注册、Ollama 身份/能力验证、租户隔离存储和迁移。
  - 文件：`evaluation/EmbeddingModelRegistry.java`, `evaluation/OllamaEmbeddingGateway.java`, `evaluation/EvaluationRepository.java`, `db/V21__add_embedding_evaluation.sql`。
