<template>
  <article v-bind="attrs" class="chunk-card" :aria-disabled="actionsDisabled ? 'true' : 'false'">
...
<script setup>
import { computed, defineAsyncComponent, onBeforeUnmount, reactive, ref, useAttrs, watch } from 'vue'
