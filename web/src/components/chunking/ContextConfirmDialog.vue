<template>
  ...
  >
    ...
    <dl v-else class="confirm-summary" aria-label="分块补充上文统计">
    ...
    <p v-if="!hierarchical && unitSummary" class="unit-summary" data-testid="confirm-unit-summary">补充上限单位：{{ unitSummary }}</p>
